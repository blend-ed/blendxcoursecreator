...
"""
blendxcoursecreator documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'blendxcoursecreator',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/Blend-ed/blendxcoursecreator",
...
#
# html_title = 'blendxcoursecreator v0.0.1'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'AI Course Creator App by Blend-ed',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'blendxcoursecreator'),
                os.path.join(root_path, 'blendxcoursecreator/migrations')])

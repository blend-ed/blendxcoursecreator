#!/usr/bin/env python
"""
Package metadata for blendxcoursecreator.
"""
import os
import re
import sys
...
VERSION = get_version('blendxcoursecreator', '__init__.py')
...
setup(
    ...
    entry_points={
        "cms.djangoapp": [
            "blendxcoursecreator = blendxcoursecreator.apps:BlendxcoursecreatorConfig",
        ],
    },
)
